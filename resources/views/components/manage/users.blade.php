...
<div class="card mt-2 text-center">
    ...
    <div class="card-block">
        ...
        <div class="tab-content">
            <div class="tab-pane fade {{ Session::has('view_users') || Session::has('add_user_error') || Session::has('add_user_status')?'show active':'' }}" id="addUsers" role="tabpanel">
                <div class="card p-2">
                    <div class="">
                        @if(Session::has('add_user_status'))
                        <div class="alert alert-success" role="alert">
                            <strong>{{Session::has('add_user_status')?Session::get('add_user_status'):''}} {{Session::has('user_status')?Session::get('user_status'):'' }}</strong>
            ...
            <div class="tab-pane fade {{ Session::has('edit_user') || Session::has('edit_user_status') || Session::has('edit_user_error') || Session::has('user_status')?'show active':'' }}" id="manageUsers" role="tabpanel">
                <div class="card p-2">
                    <div class="">
                        @if(Session::has('edit_user_status') || Session::has('user_status'))
                        <div class="alert alert-success" role="alert">
                            <strong>{{ Session::has('edit_user_status')?Session::get('edit_user_status'):''}} {{Session::has('user_status')?Session::get('user_status'):'' }}</strong>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">
                                {{ (Session::has('edit_user') || Session::has('edit_user_error'))?'Edit':'Add' }} User
                            </h5>
                        ...
                        <div class="modal-body">
                            <div
                                class="form-group row @if($errors->has('firstname')){{ 'has-danger' }}@elseif(old('firstname')){{ 'has-success' }}@endif">
                                <label for="inputHorizontalSuccess"
                                    class="col-sm-3 col-form-label text-right"><small>First Name</small></label>
                                <div class="col-sm-9">
                                    <input type="text" name="firstname"
                                        value="{{ Session::has('edit_user')?Session::get('edit_user')->firstname:old('firstname') }}"
                                        class="form-control @if($errors->has('firstname')){{ 'form-control-danger' }}@elseif(old('firstname')){{ 'form-control-success' }}@endif"
                                        id="inputHorizontalSuccess" placeholder="Eg. Masumbuko">
                            ...
                            <div
                                class="form-group row @if($errors->has('secondname')){{ 'has-danger' }}@elseif(old('secondname')){{ 'has-success' }}@endif">
                                <label for="inputHorizontalWarning"
                                    class="col-sm-3 col-form-label text-right"><small>Second Name</small></label>
                                <div class="col-sm-9">
                                    <input type="text" name="secondname"
                                        value="{{ Session::has('edit_user')?Session::get('edit_user')->secondname:old('secondname') }}"
                                        class="form-control @if($errors->has('secondname')){{ 'form-control-danger' }}@elseif(old('secondname')){{ 'form-control-success' }}@endif"
                                        id="inputHorizontalWarning" placeholder="Eg. Polepole">
                            ...
                            <div
                                class="form-group row @if($errors->has('username') && old('username')){{ 'has-warning' }}@elseif($errors->has('username')){{ 'has-danger' }}@elseif(old('username')){{ 'has-success' }}@endif">
                                <label for="inputHorizontalDnger" class="col-sm-3 col-form-label text-right"><small>User
                                        Name</small></label>
                                <div class="col-sm-9">
                                    <input type="text" name="username"
                                        value="{{ Session::has('edit_user')?Session::get('edit_user')->username:old('username') }}"
                                        class="form-control @if($errors->has('username') && old('username')){{ 'form-control-warning' }}@elseif($errors->has('username')){{ 'form-control-danger' }}@elseif(old('username')){{ 'form-control-success' }}@endif"
                            ...
                            <div
                                class="form-group row @if($errors->has('email') && old('email')){{ 'has-warning' }}@elseif($errors->has('email')){{ 'has-danger' }}@elseif(old('email')){{ 'has-success' }}@endif">
                                <label for="inputHorizontalSuccess"
                                    class="col-sm-3 col-form-label text-right"><small>Email</small></label>
                                <div class="col-sm-9">
                                    <input type="email" name="email"
                                        value="{{ Session::has('edit_user')?Session::get('edit_user')->email:old('email') }}"
                                        class="form-control @if($errors->has('email') && old('email')){{ 'form-control-warning' }}@elseif($errors->has('email')){{ 'form-control-danger' }}@elseif(old('email')){{ 'form-control-success' }}@endif"
                                        id="inputHorizontalSuccess" placeholder="Eg. masumbuko.polepole@wfp.org">
                                    @if($errors->has('email'))
                            ...
                            <div
                                class="form-group row @if($errors->has('title')){{ 'has-danger' }}@elseif(old('title')){{ 'has-success' }}@endif">
                                <label for="inputHorizontalWarning"
                                    class="col-sm-3 col-form-label text-right"><small>Title</small></label>
                                <div class="col-sm-9">
                                    <input type="text" name="title"
                                        value="{{ Session::has('edit_user')?Session::get('edit_user')->title:old('title') }}"
                                        class="form-control @if($errors->has('title')){{ 'form-control-danger' }}@elseif(old('title')){{ 'form-control-success' }}@endif"
                                        id="inputHorizontalWarning" placeholder="Eg. Store Keeper">
                                    @if($errors->has('title'))
                            ...
                            <div
                                class="form-group row @if($errors->has('department')){{ 'has-danger' }}@elseif(old('department')){{ 'has-success' }}@endif">
                                <label for="inputHorizontalDnger"
                                    class="col-sm-3 col-form-label text-right"><small>Department</small></label>
                                <div class="col-sm-9">
                                    <input type="text" name="department"
                                        value="{{ Session::has('edit_user')?Session::get('edit_user')->department:old('department') }}"
                                        class="form-control @if($errors->has('department')){{ 'form-control-danger' }}@elseif(old('department')){{ 'form-control-success' }}@endif"
                                        id="inputHorizontalDnger" placeholder="Eg. Supply Chain">
                            ...
                            <div
                                class="form-group row @if($errors->has('dutystation')){{ 'has-danger' }}@elseif(old('dutystation')){{ 'has-success' }}@endif">
                                <label for="inputHorizontalSuccess"
                                    class="col-sm-3 col-form-label text-right"><small>Duty Station</small></label>
                                <div class="col-sm-9">
                                    <input type="text" name="dutystation"
                                        value="{{ Session::has('edit_user')?Session::get('edit_user')->dutystation:old('dutystation') }}"
                                        class="form-control @if($errors->has('dutystation')){{ 'form-control-danger' }}@elseif(old('dutystation')){{ 'form-control-success' }}@endif"
                                        id="inputHorizontalSuccess" placeholder="Eg. Isaka">
