...
<!--                                    <li class="nav-item dropdown">
                            ...
                            <div data-spy="scroll" data-target="#navbar-example2" data-offset="0" class="scrollspy-example" style="position: relative; height: 310px; overflow-y: scroll">
                                ...
                                <p>
                                    ...
                                    <i class="fa fa-file-text" aria-hidden="true"></i> <a class="text-muted font-italic" href="{{URL::to('/resource/Administration/'.encrypt('2017_04_05 - Tanzania line of sight_FINAL.jpg'))}}">Tanzania line of sight</a><br>
