...
<!--                                    <li class="nav-item dropdown">
                            ...
                            <div data-spy="scroll" data-target="#navbar-example2" data-offset="0" class="scrollspy-example" style="position: relative; height: 310px; overflow-y: scroll">
                                ...
                                <p>
                                    ...
                                    <i class="fa fa-file-text" aria-hidden="true"></i> <a class="text-muted font-italic" href="{{URL::to('/resource/Administration/'.encrypt('TZ01 BR2_Revised CSP narrative_7June2018_budget revision 2.pdf'))}}">Revised CSP narrative — United Republic of Tanzania (2017–2021)</a><br>
