    ...
    <div class="col-sm-7">
        <div class="row">
           <div class="dnWaterfall">
              <img class="waterfall-img" lazy-src="./image/p4.jpg" style="width: 160px;border-radius: 16px;">
              <img class="waterfall-img" lazy-src="./image/p8.jpg" style="width: 160px;border-radius: 16px;">
              <img class="waterfall-img" lazy-src="./image/p2.jpg" style="width: 160px;border-radius: 16px;">
              <img class="waterfall-img" lazy-src="./image/p3.jpg" style="width: 160px;border-radius: 16px;">
              <img class="waterfall-img" lazy-src="./image/p4.jpg" style="width: 160px;border-radius: 16px;">
              <img class="waterfall-img" lazy-src="./image/p5.jpg" style="width: 160px;border-radius: 16px;">
              <img class="waterfall-img" lazy-src="./image/p6.jpg" style="width: 160px;border-radius: 16px;">
              <img class="waterfall-img" lazy-src="./image/p7.jpg" style="width: 160px;border-radius: 16px;">
              <img class="waterfall-img" lazy-src="./image/p8.jpg" style="width: 160px;border-radius: 16px;">
              <img class="waterfall-img" lazy-src="./image/p10.jpg" style="width: 160px;border-radius: 16px;">
              <img class="waterfall-img" lazy-src="./image/p4.jpg" style="width: 160px;border-radius: 16px;">
              <img class="waterfall-img" lazy-src="./image/p5.jpg" style="width: 160px;border-radius: 16px;">
              <img class="waterfall-img" lazy-src="./image/p7.jpg" style="width: 160px;border-radius: 16px;">
              <img class="waterfall-img" lazy-src="./image/p12.jpg" style="width: 160px;border-radius: 16px;">
              <img class="waterfall-img" lazy-src="./image/p8.jpg" style="width: 160px;border-radius: 16px;">
              <img class="waterfall-img" lazy-src="./image/p12.jpg" style="width: 160px;border-radius: 16px;">
         </div>
    </div>
...
<!---Script tags for pinterest layout plugin (overlayed pictures) -->
