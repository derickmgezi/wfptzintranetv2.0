            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'account_suffix' => env('ADLDAP_ACCOUNT_SUFFIX', '@wfp.org'),
                ...
                */
                ...
                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', 'global.wfp.org')),
                ...
                */
                ...
                'base_dn' => env('ADLDAP_BASEDN', 'dc=wfp,dc=org'),
                ...
                */
                ...
                'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'admruganuzad'),
                'admin_password' => env('ADLDAP_ADMIN_PASSWORD', 'Welcome2WFP@12'),
